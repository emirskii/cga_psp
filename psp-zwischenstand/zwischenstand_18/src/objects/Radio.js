class Radio extends THREE.Group {
    ...
    addParts() {
        ...
        var dreiecktasteMaterial = new THREE.MeshLambertMaterial({
            color: 0x666666
        });
        var dreiecktaste = new THREE.Mesh(dreiecktasteGeometry, dreiecktasteMaterial);
        ...
        var mittelschichtMaterial = new THREE.MeshLambertMaterial({
            color: 0x8a8a8a
        });
        var mittelschicht = new THREE.Mesh(mittelschichtGeometry, mittelschichtMaterial);
        ...
        var lringMaterial = new THREE.MeshLambertMaterial({
            color: 0x8a8a8a
        });

        var lring = new THREE.Mesh(lringGeometry, lringMaterial);
        lring.position.x = -15;
        lring.position.y = 0;
        lring.position.z = -1;
        ...
        //Linke Seite vom Ring CSG
        var intersect = threecsg.intersect(lring, zylinderring, lringMaterial);
        this.add(intersect);


        //Rechte Seite vom Ring CSG
        var rringGeometry = new THREE.BoxGeometry(10,10,1);
        var rringMaterial = new THREE.MeshLambertMaterial({
            color: 0x8a8a8a
        });
        var rring = new THREE.Mesh(rringGeometry, rringMaterial);
        rring.position.x = 15;
        rring.position.y = 0;
        rring.position.z = -1;
        ...
        //Rechte Seite vom Ring CSG
        var intersect = threecsg.intersect(rring,zylinderrechts, rringMaterial);
        this.add(intersect);
